...
function Notification(){
    ...
    return(
        ...
        <div className="flex">
          ...
          <div className="flex flex-col border ml-10 h-60 rounded-lg w-220 border-gray-300">
            <div className="flex ml-5 mt-8 gap-x-180">
                   ...
                   <div className="flex flex-col ml-5">
                    <div className="flex gap-x-2">
                      <svg className="cursor-pointer"width="40" height="40" viewBox="0 0 40 40">
                          ...
                          <h1 className="mt-2 text-gray-500 text-sm">
