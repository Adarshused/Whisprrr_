...
function Preference(){
   ...
   <h1 className="font-extrabold text-xl" style={{fontFamily:'Times New Roman,Serif'}}>Write About Yourself</h1>
     <h5 className="text-gray-400">Provide a brief summary about yourself—your role, interests, and key expertise.</h5>
         ...
         <div className="flex flex-col w-227 rounded-lg ml-14 h-40 mt-6  shadow-sm border border-gray-300 ">
            <div className="flex">
            ...
            <button className="h-6 " type={!isEditAbout ? "button" : "submit"}>
               <label className="px-2 mt-5 ml-175 w-20 h-6  cursor-pointer font-extrabold text-[#5235E8] px-6 py-3 hover:text-[#9785F1] flex items-center justify-center"
      ...
      <div className="mt-1 ml-10 w-210 h-20 border rounded-lg border-gray-300" >
                   <input  className="ml-5 w-200 h-full text-gray-400 outline-none" type="text" defaultValue={about} name="about" readOnly={isEditAbout}/>
                   </div>
         </div>
         </form>
        </div>
   ...
   <h1 className="font-extrabold text-xl" style={{fontFamily:'Times New Roman,Serif'}}>Address</h1>
     <h5 className="text-gray-400">Ensure your current residential address is accurate and up-to-date</h5>
       ...
       <form onSubmit={HandleSubmitAddress}>
         <div className="flex flex-col w-230 rounded-lg ml-6 h-60 shadow-sm border border-gray-300 ">
          <div className="flex ">
            <div className="flex flex-col ml-6 mt-4  ">
                   ...
                   <input  className="ml-5 w-105 h-full text-gray-400 outline-none" type="text" defaultValue={plot} name="plot" readOnly={isEditAddress}/>
                   </div>
                </div>
                   <div className="flex flex-col ml-2  ">
                  <div className="flex mt-2 ml-2">
                   <h5 className="font-extrabold mt-2 ml-4 " style={{fontFamily:'Times New Roman,Serif'}}>Area/Landmark</h5>
                ...
                style={{ fontFamily: 'Times New Roman, Serif' }} onClick={()=>{
                 ...
                 >{isEditAddress? 'EDIT' : 'SAVE'}
                   ...
                   <input  className="ml-5 w-105 h-full text-gray-400 outline-none" type="text" defaultValue={area} name="area" readOnly={isEditAddress} />
                   </div>
                </div>
          </div>
             <div className="flex flex-col ml-6   ">
                   ...
                   <input  className="ml-5 w-105 h-full text-gray-400 outline-none" type="text" defaultValue={city} name="city" readOnly={isEditAddress} />
                   </div>
                </div>
            <div className="flex flex-col ml-6   ">
                   <h5 className="font-extrabold text-sm " style={{fontFamily:'Times New Roman,Serif'}}>State</h5>
                   <div className=" mt-1 w-212 h-11 border rounded-lg border-gray-300" >
                   <input  className="ml-5 w-105 h-full text-gray-400 outline-none" type="text" defaultValue={state} name="state" readOnly={isEditAddress} />
                   </div>
                </div>
        </div>
        </form>
